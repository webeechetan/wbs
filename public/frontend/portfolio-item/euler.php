...
<head>
    ...
    <link href="ico/apple-touch-icon-114-precomposed.jpg" rel="apple-touch-icon" sizes="114x114">
    <link href="ico/apple-touch-icon-72-precomposed.jpg" rel="apple-touch-icon" sizes="72x72">
    <link href="ico/apple-touch-icon-57-precomposed.jpg" rel="apple-touch-icon">
    <link href="ico/favicon.jpg" rel="shortcut icon">
...
<body class="page-loaded">
    ...
    <div class="navigation-menu">
        <div class="inner">
            ...
            <!-- end sides -->
            <div class="sides">
                <h2>Agensy is a creative portfolio <strong>Themeforest</strong> layout will help freelancers and digital agencies to create unique websites.</h2>
                <address>Kristiatik 15th Street, Floot 17<br>Kiev, Ukraine 78692<br> <a href="#">hello@agensy.com.ua </a> +380 98 294 80 86</address>
            </div>
            <!-- end sides -->
        </div>
        <!-- end inner -->
    ...
    <aside class="left-side">
        <div class="logo">
            <img src="../images/webeesocial_icon.svg" alt="Image">
        </div>
        <ul>
    ...
    <header class="header">
        <nav class="navbar">
            <div class="inner">
                <div class="logo"> <a href="index.php"><img src="../images/webeesocial_logo.svg" alt="Image"></a> </div>
                <!-- end phone -->
                <div class="main-menu">
                    <ul>
                        <li><a href="about-us.php">About Us</a></li>
        ...
        <div class="container">
            <div class="row">
                <div class="col-sm-6 col-lg-4 mb-4 mb-sm-5">
                    <div class="titles">
                        <h5>Meet the Client</h5>
                        <p>Euler Motors is a fully-loaded OEM that builds electric vehicles, focusing majorly on last mile logistics.</p>
                    </div>
                </div>
                <div class="col-sm-6 col-lg-4 mb-4 mb-sm-5">
                    <div class="titles">
                ...
                <div class="col-sm-6 col-lg-4 mb-4 mb-sm-5">
                    <div class="titles">
                        <h5>The Challenge</h5>
                        <p>Ideating an entirely customized website with various functionalities from scratch.</p>
                    </div>
                </div>
                <div class="col-sm-6 col-lg-4 mb-4 mb-sm-5 mb-lg-0">
                    <div class="titles">
                        <h5>What We Did</h5>
                        <p>We customized and developed a few designs with coding functionalities to be at par with the client’s brief. Banners and icons were created, content management systems were established and publishing controls were implemented for the website.</p>
                    </div>
                </div>
                <div class="col-sm-6 col-lg-4 mb-4 mb-sm-5 mb-lg-0">
                    <div class="titles">
                ...
                <div class="col-sm-6 col-lg-4">
                    <div class="titles">
                        <h5>Info</h5>
                        <p><b class="mr-2">Date:</b> December 19, 2021</p>
                        <p><b class="mr-2">Category:</b> Design, graphics, Websites</p>
                    </div>
                </div>
            </div>
            <div class="row sec-space pb-0">
                <div class="col-12">
                    <div class="design-reff">
                        <img src="https://www.webeesocial.com/wp-content/uploads/2021/12/img1.jpg" alt="image">
                        <img src="https://www.webeesocial.com/wp-content/uploads/2021/12/img6.jpg" alt="image">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-4 wow fadeInUp">
                    <figure class="logo mb-3"><img src="../images/logo.png" alt="Webeesocial Logo"></figure>
                ...
                <div class="col-lg-4 col-md-6 wow fadeInUp">
                    ...
                    <address>Contact us <a href="contact-us.php" class="text-link text-primary">here</a></address>
                    <address><a href="mailto:saurav.k@webeesocial.com">saurav.k@webeesocial.com</a></address>
                    <img src="../images/Google-partners-logo.jpg" alt="Google Partner Logo">
                </div>
                <!-- end col-3 -->
