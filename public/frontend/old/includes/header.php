...
<head>
    ...
    <meta name="twitter:description" content="Webeesocial | Digital Lab & Creative Solutions">
...
<body class="page-loaded">
    ...
    <header class="header">
        <nav class="navbar">
            <div class="inner">
                <div class="logo"> <a href="index.html"><img src="images/webeesocial_logo.svg" alt="Image"></a> </div>
                <!-- end phone -->
                <div class="main-menu">
                    <ul>
                        <li><a href="#">About</a></li>
