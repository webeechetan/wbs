...
<head>
    ...
    <!-- FAVICON FILES -->
    <link href="{{ asset('frontend') }}/ico/apple-touch-icon-144-precomposed.jpg" rel="apple-touch-icon" sizes="144x144">
    <link href="{{ asset('frontend') }}/ico/apple-touch-icon-114-precomposed.jpg" rel="apple-touch-icon" sizes="114x114">
    <link href="{{ asset('frontend') }}/ico/apple-touch-icon-72-precomposed.jpg" rel="apple-touch-icon" sizes="72x72">
    <link href="{{ asset('frontend') }}/ico/apple-touch-icon-57-precomposed.jpg" rel="apple-touch-icon">
    <link href="{{ asset('frontend') }}/ico/favicon.jpg" rel="shortcut icon">
    ...
    <div class="navigation-menu">
        <div class="inner">
            ...
            <div class="sides">
                ...
                <!-- end map -->
                <figure><img src="{{ asset('frontend') }}/images/office01.jpg" alt="Image">
                    <a href="#map" data-fancybox><img src="{{ asset('frontend') }}/images/icon-map-marker.svg" alt="Image"></a>
                </figure>
            </div>
            <!-- end sides -->
            <div class="sides">
