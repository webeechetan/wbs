            ...
            <div class="col-md-4 sec-space pt-0">
                <div class="card-icon">
                    <div class="card-icon-top">
                        ...
                        <div class="titles"><h6 class="font-weight-700">Digital Strategy and Planning</h6></div>
                    </div>
            ...
            <div class="col-md-4 sec-space pt-0">
                <div class="card-icon">
                    <div class="card-icon-top">
                        ...
                        <div class="titles"><h6 class="font-weight-700">Creative Strategy and Web Graphics Design</h6></div>
                    </div>
                    <div class="card-icon-content">
            ...
            <div class="col-md-4 sec-space pt-0">
                <div class="card-icon">
                    <div class="card-icon-top">
                        ...
                        <div class="titles"><h6 class="font-weight-700">Social Media Marketing</h6></div>
                    </div>
                    <div class="card-icon-content">
            ...
            <div class="col-md-4 sec-space pt-0">
                <div class="card-icon">
                    <div class="card-icon-top">
                        ...
                        <div class="titles"><h6 class="font-weight-700">Videos, GIFs and Content Marketing</h6></div>
                    </div>
                    <div class="card-icon-content">
            ...
            <div class="col-md-4 sec-space pt-0">
                <div class="card-icon">
                    <div class="card-icon-top">
                        ...
                        <div class="titles"><h6 class="font-weight-700">Website Design and Development</h6></div>
                    </div>
                    <div class="card-icon-content">
            ...
            <div class="col-md-4 sec-space pt-0">
                <div class="card-icon">
                    <div class="card-icon-top">
                        ...
                        <div class="titles"><h6 class="font-weight-700">SEO and Search Engine Marketing</h6></div>
                    </div>
                    <div class="card-icon-content">
            ...
            <div class="col-md-4 sec-space pt-0">
                <div class="card-icon">
                    <div class="card-icon-top">
                        ...
                        <div class="titles"><h6 class="font-weight-700">Email Marketing</h6></div>
                    </div>
                    <div class="card-icon-content">
            ...
            <div class="col-md-4 sec-space pt-0">
                <div class="card-icon">
                    <div class="card-icon-top">
                        ...
                        <div class="titles"><h6 class="font-weight-700">Web Analytics</h6></div>
                    </div>
                    <div class="card-icon-content">
            ...
            <div class="col-md-4 sec-space pt-0">
                <div class="card-icon">
                    <div class="card-icon-top">
                        ...
                        <div class="titles"><h6 class="font-weight-700">Media Planning and Buying</h6></div>
                    </div>
                    <div class="card-icon-content">
            ...
            <div class="col-md-4">
                <div class="card-icon">
                    <div class="card-icon-top">
                        ...
                        <div class="titles"><h6 class="font-weight-700">Shopify Website & Development</h6></div>
                    </div>
                    <div class="card-icon-content">
