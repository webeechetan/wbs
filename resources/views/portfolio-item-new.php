...
<body class="page-loaded color-undefined" cz-shortcut-listen="true">
    ...
    <div class="navigation-menu">
        <div class="inner">
            ...
            <div class="sides sides-img">
                <figure>
                    <img src="http://localhost/github/wbs/frontend/images/sidebar-img.jpg" width="100%" alt="Team Image">
                </figure>
            </div>
            <!-- end sides -->
            <div class="sides">
                ...
                <address class="mb-4">
                    <img src="http://localhost/github/wbs/frontend/images/icon-map-marker.svg" width="18" alt="Location"> <span>New Delhi, India | North York, Toronto | Dubai, UAE</span>
                </address>
                <div class="row">
                    <div class="col-lg-6">
                        <address class="mb-4">
                            <h6>For Business Enquiries:</h6>
                            <a href="mailto:saurav.k@webeesocial.com"><img src="http://localhost/github/wbs/frontend/images/icon-mail.svg" width="18" alt="Email"> <span>saurav.k@webeesocial.com</span></a>
                        </address>
                    </div>
                    <div class="col-lg-6">
                        <address class="mb-4">
                            <h6>For Jobs Enquiries:</h6>
                            <a href="mailto:hr@webeesocial.com"><img src="http://localhost/github/wbs/frontend/images/icon-mail.svg" width="18" alt="Email"> <span>hr@webeesocial.com</span></a>
                        </address>
                    </div>
                </div>
                <div class="row">
                    <div class="col-lg-6">
                        <address class="mb-0"><img src="http://localhost/github/wbs/frontend/images/icon-support.svg" width="18" alt="Suport"> Contact us <a href="get-in-touch" class="btn-link text-underline"><span>here</span></a></address>
                    </div>
                    <div class="col-lg-6">
                        <address class="mb-0">
                            <h6>Follow us:</h6>
    ...
    <aside class="left-side">
        <div class="logo">
            <img src="http://localhost/github/wbs/frontend/images/webeesocial_icon.svg" alt="Image">
        </div>
        <ul>
        ...
        <a href="#top" class="gotop"><img src="http://localhost/github/wbs/frontend/images/icon-gotop.svg" alt="Image"></a>
    </aside>
    <!-- end left-side -->
    <header class="header">
        <nav class="navbar">
            <div class="inner">
                <div class="logo"> <a href="http://localhost/github/wbs"><img src="http://localhost/github/wbs/frontend/images/logo-tm.png" alt="Webeesocial Logo"></a> </div>
                <!-- end phone -->
                <div class="main-menu">
                    <ul>
                        <li><a href="http://localhost/github/wbs/about-us">About Us</a></li>
                        ...
                        <li><a href="http://localhost/github/wbs/work-with-us">Work With Us</a></li>
                    </ul>
                </div>
                <!-- end main-menu -->
    ...
    <section class="">
        <div class="container">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="http://localhost/github/wbs">Home</a></li>
                    <li class="breadcrumb-item"><a href="http://localhost/github/wbs/our-work">Our Work</a></li>
                    <li class="breadcrumb-item"><a href="http://localhost/github/wbs/portfolio-item/euler">Euler</a></li>
                </ol>
            </nav>
            <div class="zikzak-container">
                <h2 class="title-banner mb-4">Euler</h2>
                <h4>Best Oasis is a ship recycling company.</h4>
            </div>
        </div>
        <!-- end container -->
    </section>
    <section class="sec-space">
        <div class="container">
            <div class="row">
                <div class="col-md-8">
                    <img src="https://www.webeesocial.com/wp-content/uploads/2021/12/img1.jpg" width="100%" alt="">
                    <img src="https://www.webeesocial.com/wp-content/uploads/2021/12/img1.jpg" width="100%" alt="">
                    <img src="https://www.webeesocial.com/wp-content/uploads/2021/12/img1.jpg" width="100%" alt="">
                    <img src="https://www.webeesocial.com/wp-content/uploads/2021/12/img1.jpg" width="100%" alt="">
                </div>
                    ...
                    <div class="accordion" id="accordionExample">
                        <div class="card">
                            <div class="card-header" id="headingOne">
                                <h5 class="mb-0"><a href="javascript:;" data-toggle="collapse" data-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne">Meet the Client:</a></h5>
                            </div>
                        ...
                        <div class="card">
                            <div class="card-header" id="headingTwo">
                                <h5 class="mb-0"><a href="javascript:;" data-toggle="collapse" data-target="#collapseTwo" aria-expanded="true" aria-controls="collapseTwo">The objective:</a></h5>
                            </div>
                            <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionExample">
                            <div class="card-body">
                                <ul><li>Build presence on social media platforms like LinkedIn and Twitter.</li><li>Posting relevant information related to the industry.</li><li>Derive traffic on the website through optimizing the website.</li></ul>
                            </div>
                            </div>
                        </div>
                        <div class="card">
                            <div class="card-header" id="headingThree">
                                <h5 class="mb-0"><a href="javascript:;" data-toggle="collapse" data-target="#collapseThree" aria-expanded="true" aria-controls="collapseThree">What We Did:</a></h5>
                            </div>
                            <div id="collapseThree" class="collapse" aria-labelledby="headingThree" data-parent="#accordionExample">
                                <div class="card-body">
                                    <ul><li>To build an audience on social media we posted industry-related information.</li><li>We also focused on posting current and on-going industry trends and developments, which received the highest engagement.</li><li>To increase the traffic on the website, we targeted keywords which were related to the services offered and have high search volume.</li></ul>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-4 wow fadeInUp" style="visibility: hidden; animation-name: none;">
                <figure class="logo mb-3"><img src="http://localhost/github/wbs/frontend/images/logo.png" alt="Webeesocial Logo"></figure>
            ...
            <!-- end col-5 -->
            <div class="col-lg-4 col-md-6 wow fadeInUp" style="visibility: hidden; animation-name: none;">
                <div class="titles">
                    <h6>Our Offices</h6>
                </div>
                <address class="icon-list"><img src="http://localhost/github/wbs/frontend/images/icon-map-marker.svg" alt="Location"> <span>Sector 22, Dwarka, New Delhi 110075</span></address>
                <address class="icon-list"><img src="http://localhost/github/wbs/frontend/images/icon-map-marker.svg" alt="Location"> <span>Saket District Centre, District Centre, Sector 6, Pushp Vihar, New Delhi, Delhi 110017</span></address>
                <address class="icon-list"><img src="http://localhost/github/wbs/frontend/images/icon-map-marker.svg" alt="Location"> <span>AE Clover Bay Tower, Marasi Drive, Business Bay, Dubai, UAE P. O. Box - 391483</span></address>
                <address class="icon-list"><img src="http://localhost/github/wbs/frontend/images/icon-map-marker.svg" alt="Location"> <span>CA North York, ON M3A 2Y7, Canada</span></address>
            </div>
            <!-- end col-4 -->
            <div class="col-lg-4 col-md-6 wow fadeInUp" style="visibility: hidden; animation-name: none;">
                <div class="titles">
